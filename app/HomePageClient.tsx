      ...
      <section className="relative pt-16 pb-12 sm:pt-24 sm:pb-16 lg:pt-32">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <motion.p
            ...
            className="mt-6 mx-auto max-w-2xl text-base sm:text-lg text-zinc-400 leading-relaxed"
          >
            Akses langsung ke spesialis presentasi investor, video komersial, fotografi produk premium, dan arsitek UI/UX. Transparan dari tarif dasar hingga persentase DP, terjamin dengan perlindungan pengerjaan terkurasi.
          </motion.p>
